 ...
 * Rambo (Combat) (combat score), Brick wall (Defence) (defense score) -
 * in one combined message, signed "-BigChazzza Bot". No-ops quietly if
 * there's no current match or nobody has any stats recorded yet.
 */
